...
class Migration_Core
{
	...
	public function __construct($output = FALSE, $group = 'default')
	{
		...
		// Set driver name
		$driver = 'Migration_'.ucfirst($platform).'_Driver';
	...
	public function rename_column($table_name, $column_name, $new_column_name)
	{
		...
		$ret = $this->driver->rename_column($table_name, $column_name, $new_column_name);
		$this->log("DONE<br />");
		return $ret;
	}
	...
	public function remove_column($table_name, $column)
	{
        ...
        $this->remove_column($table_name, $name);
		  }
		  return TRUE;
		}
		else {
  		$this->log("Removing column '$column' in table '$table_name'...");
  		$ret = $this->driver->remove_column($table_name, $column);
  		$this->log("DONE<br />");
  		return $ret;		  
		}
	}
