...
class download_Core {
  ...
  /**
   * Transfer file without forcing download prompt.
   * Based on download::force, just removed a few headers
   * that were generating errors.
	 ...
	 * @return  void
	 */
	public static function deliver($filename = NULL, $data = NULL, $nicename = NULL)
	{
		if (empty($filename))
			return FALSE;
  ...
  /**
   * Transfer using x-sendfile header to send the request directly to nginx.
   */
