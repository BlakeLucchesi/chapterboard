	...
	*/
	...
	public function write($id, $data)
	{
		...
		if ($this->session_id === NULL)
		{
			...
			$query = $this->db->query("INSERT INTO {$this->table} (session_id, last_activity, data) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE last_activity = ?, data = ?", array(
        $data['session_id'], $data['last_activity'], $data['data'], $data['last_activity'], $data['data']
			));
		}
