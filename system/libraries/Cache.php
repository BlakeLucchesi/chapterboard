...
class Cache_Core {
  ...
  public function get_stats($extended = FALSE) {
    if ($extended && method_exists($this->driver, 'get_extended_stats')) {
      return $this->driver->get_extended_stats();
    }
    else if (method_exists($this->driver, 'get_stats')) {
