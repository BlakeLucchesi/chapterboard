<div id="comment-edit">
  <div id="breadcrumbs">
    <div><?= html::anchor('files/study', 'Study Bank') ?> &raquo; <?= html::anchor('files/study/course/'. $this->course->id, $this->course->title) ?></div>
  </div>
      ...
      <div class="clearfix">
        ...
        <div class="split-left">
          <div class="clearfix">
            ...
            <?= form::submit('post', 'Save Comment'); ?> or <?= html::anchor('files/study/course/'. $this->course->id, 'Cancel') ?>
  ...
  <div class="comment depth-<?= strlen(preg_replace('/\./', '', $this->comment->thread)) ?>">
    <div class="comment-header"><div class="comment-header-inner clearfix">
      ...
      <div class="topic-links">
        <?php if (A2::instance()->allowed($this->comment, 'delete')): ?>
          <?= html::anchor('files/study/comment/delete/'. $this->comment->id, 'Unpublish') ?>
        <?php endif; ?>
      </div>
    </div></div>
